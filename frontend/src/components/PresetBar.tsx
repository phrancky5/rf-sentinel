...
const PRESET_GROUPS: PresetGroup[] = [
  ...
  {
    group: 'Satellite (L-band)',
    presets: [
      { label: 'Inmarsat',  startMhz: 1525.0,  stopMhz: 1559.0, antenna: 'Small, 1 section (~1030 MHz) — L-band patch preferred' },
      { label: 'Iridium',   startMhz: 1616.0,  stopMhz: 1626.5, antenna: 'Small, 1 section (~1030 MHz) — L-band patch preferred' },
    ],
  },
];
